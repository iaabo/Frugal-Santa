      ...
      <div className="img-container-about">
        ...
        <div className="questions">
          <h1 className="question1">
            Do you know a family that owns a store with cool gifts? Contact us!
            with alert. Put here a cool form.
          </h1>
          <h1 className="question2">
            Do you need support? Speak directly with Oscar. Put here the image
            of Oscar with alert.
          </h1>
        </div>
        <Footer />
